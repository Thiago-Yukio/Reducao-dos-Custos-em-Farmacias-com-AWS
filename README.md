...
**Foco da ferramenta:** Armazenamento de documentos e dados corporativos.
...
* Redução dos custos de armazenamento local.
* Maior segurança e durabilidade dos dados.
* Facilidade de acesso e compartilhamento de documentos.

---

### Etapa 2: Amazon EC2

**Foco da ferramenta:** Hospedagem e processamento de aplicações corporativas.
...
* Redução dos custos de infraestrutura física.
...
**Foco da ferramenta:** Automação de processos operacionais.

**Descrição do caso de uso:**

O AWS Lambda foi implementado para automatizar tarefas rotineiras, como processamento de pedidos, atualização de estoque, envio de notificações e geração de relatórios operacionais. Por utilizar um modelo serverless, a empresa paga apenas pelo tempo efetivo de execução das funções, eliminando custos relacionados a servidores dedicados para tarefas de baixa utilização.

**Benefícios obtidos:**

* Redução dos custos operacionais.
* Automatização de processos repetitivos.
* Menor necessidade de gerenciamento de servidores.
